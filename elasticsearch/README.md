...
```console
$ helm install <helm-repo>/elasticsearch
```
...
```console
$ helm install --name my-release <helm-repo>/elasticsearch
```
...
```console
$ helm install --name my-release -f values.yaml <helm-repo>/elasticsearch
```
